...
export const OAKLEAVES = new Block("oak_leaves",  true, false,
    new CubeMeshOneTexture("block_textures/oak_tree_textures/oak_leaves.png"));
export const DIRT = new Block("dirt",  true, false,
    new CubeMeshOneTexture("block_textures/one_texture/dirt.png"));
export const STONE = new Block("stone",  true, false,
    new CubeMeshOneTexture("block_textures/one_texture/stone.png"));
export const GLASS = new Block("glass",  true, true,
    new CubeMeshOneTexture("block_textures/one_texture/glass.png"));
export const COAL = new Block("coal",  true, false,
    new CubeMeshOneTexture("block_textures/one_texture/coal.png"));
export const IRON = new Block("iron",  true, false,
    new CubeMeshOneTexture("block_textures/one_texture/iron.png"));
export const MUSHROOM_BLOCK = new Block("mushroom_block",  true, false,
    new CubeMeshOneTexture("block_textures/mushroom_textures/mushroom_block.png"));
export const MUSHROOM_STEM = new Block("mushroom_stem",  true, false,
    new CubeMeshOneTexture("block_textures/mushroom_textures/mushroom_stem.png"));
export const CUCUMBER = new Block("cucumber",  true, false,
    new CubeMeshOneColor(1, new Color(0.1, 0.5, 0.2), false));
